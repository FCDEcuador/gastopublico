...
<div class="container mt-3">
	...
	<!-- BEGIN SECCION BUSCAR -->
		<div class="row mt-3 p-3 bg-light">
			<div class="col-sm-12">
				<div class="titulo border-bottom border-info text-info text-uppercase">Datos que utilizamos y Nuestros datasets</div>
			</div>
		...
		<div class="row p-3 bg-light">
			<div class="col-12 ">
				<form>
				  ...
				  <div class="form-group row justify-content-center">
				    <label for="ano_emision" class="col-sm-3 col-form-label text-uppercase text-left text-sm-right text-secondary">Periodo</label>
				    <div class="col-sm-4">
	...
	<div class="row mt-5 ">
		<div class="col-4 d-none d-sm-block">
			<h6 class="border-bottom border-default text-default font-weight-bold">DATASET</h6>
		</div>
		<div class="col-8 d-none d-sm-block">
			<h6 class="border-bottom border-default text-default font-weight-bold">DATOS</h6>
		</div>
	</div>
	<div class="row mt-3">
		<div class="col-12 mb-3 border-bottom border-info pb-3">
			<div class="row">
				<div class="col-sm-4 ">
					<h6 class="text-info">¿Cuánto se gastó en pasajes aéreos entre 2015 y 2017?</h6>
				</div>
				<div class="col-sm-8">
					<div class="text-default"><strong>Periodo: </strong> 2015-2017</div>
					<div class="text-default"><strong>Fecha de última actualización: </strong> 16-05-2018</div>
