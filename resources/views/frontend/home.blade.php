			...
			<div class="row">
				...
				<div class="col-md-4 mb-3 mb-md-0">
					...
					<article class="shadow p-3 rounded nuevoB">
						<div class="elemento">
							<div class="div-relative" >
	                            <a class="twitter-timeline" data-lang="es" data-height="600" data-width="300" data-link-color="#487d27" href="https://twitter.com/EsMiPlataEC?ref_src=twsrc%5Etfw">Tweets de EsMiPlataEC</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
	                        </div>
						</div>				
					</article>
