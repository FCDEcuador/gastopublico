...
<div class="container mt-3">
		...
		<div class="row mt-3 p-3 bg-light">
			...
			<div class="row mt-3">
				...
				<div class="col-sm-6 mt-3 mb-3 text-justify">
					<p class="text-muted">Somos una iniciativa de Fundación Ciudadanía y Desarrollo que través de la investigación y análisis de casos de corrupción y su posterior difusión en formatos abiertos y amigables, busca promover el conocimiento y debate ciudadano sobre la importancia del combate a la corrupción. </p>
					<h2 class="morado mt-3">Misión</h2>
					<p class="text-muted">Obtener, sistematizar y difundir información confiable y amigable sobre casos de corrupción en Ecuador y sus consecuencias en la vida diaria de sus habitantes.</p>
					<h2 class="morado mt-3">Visión</h2>
					<p class="text-muted">Un Ecuador en el que el sector público y privado actúen de manera sinérgica en el combate efectivo a la corrupción.</p>
				</div>
			</div>
		</div>
	...
	<div class="row mt-3 p-3 ">
		<div class="col-12">
			<h5 class="text-secondary text-center ">Con el apoyo de:</h5>
		</div>
		<div class="col-12">
