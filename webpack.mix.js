...
*******************************************************************************************/
	...
	mix.copy('resources/assets/backend/js/chat.js', 'public/backend/assets/js')
	   ...
	   // FORM VALIDATE
			...
			// Indicadores
			   	.copy('resources/assets/backend/js/form-validation/form-validation-indicator.js', 'public/backend/assets/js/form-validate')
			   	.minify('public/backend/assets/js/form-validate/form-validation-indicator.js')
			// Roles
